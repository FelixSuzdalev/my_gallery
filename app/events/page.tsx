...
// Временные данные для событий
const MOCK_EVENTS = [
  {
    id: 1,
    title: 'Цифровая меланхолия',
    type: 'Выставка',
    status: 'active',
    dateStart: '2024-05-20',
    dateEnd: '2024-06-15',
    location: "Центр М'АРС, Москва",
    image: 'https://images.unsplash.com/photo-1550684848-fac1c5b4e853?w=1200',
    description: 'Исследование влияния цифрового шума на эмоциональное состояние человека через призму генеративного искусства.'
  },
  {
    id: 2,
    title: 'Post-Industrial Vision',
    type: 'Воркашоп',
    status: 'upcoming',
    dateStart: '2024-07-05',
    dateEnd: '2024-07-06',
    location: 'Севкабель Порт, СПб',
    image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=1200',
    description: 'Двухдневный интенсив по архитектурной фотографии в условиях индустриального ландшафта.'
  },
  {
    id: 3,
    title: 'Свет и Тень: Революция',
    type: 'Аукцион',
    status: 'upcoming',
    dateStart: '2024-08-12',
    dateEnd: '2024-08-12',
    location: 'Online / Cube.Moscow',
    image: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=1200',
    description: 'Благотворительный аукцион молодых медиа-художников. Все средства пойдут на развитие арт-резиденций.'
  }
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="space-y-32 pb-32">
          {filteredEvents.map((event) => (
            <section key={event.id} className="group relative grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              ...
              <div className="lg:col-span-7 relative overflow-hidden rounded-2xl aspect-[16/9] bg-gray-100">
                ...
                <div className="absolute top-6 left-6">
                  <span className={`px-4 py-2 rounded-full text-[10px] font-bold uppercase tracking-[0.2em] shadow-xl backdrop-blur-md ${
                    event.status === 'active' ? 'bg-green-500 text-white' : 'bg-white/90 text-black'
                  }`}>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4 pt-4 border-t border-gray-50">
                    <div className="flex items-center gap-3 text-sm font-medium">
                      ...
                      {new Date(event.dateStart).toLocaleDateString('ru-RU')} — {new Date(event.dateEnd).toLocaleDateString('ru-RU')}
                    </div>
                    <div className="flex items-center gap-3 text-sm font-medium">
